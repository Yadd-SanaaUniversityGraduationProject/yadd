...
**السياسة المعتمدة:** Reminder بعد 24 ساعة، Reminder ثانٍ بعد 48 ساعة، و`Expired` بعد 72 ساعة من عدم نشاط Beneficiary. النشاط الفعلي من Beneficiary يعيد عداد عدم النشاط؛ Provider Response وحدها لا تعيده.
