...
## 2.b حزمة المخططات الجاهزة للطباعة — Print Package

النسخة البصرية النهائية لهذا النموذج متاحة كحزمة طباعة كاملة (PNG/PDF/SVG) في:

`diagrams/03-analysis/uml/use-case/print-package/`

وتتكوّن من مخططين على ورقتين A4 توضعان بجانب بعضهما ليُرى النموذج كاملًا:

1. **المخطط 1 من 2 — Core Service Journey:** المصادقة والدخول، الاستكشاف والاستفسار المباشر، مسار الطلب المنشور، المعاملة والفاتورة والشكوى.
2. **المخطط 2 من 2 — Trust, Administration & Provider Management:** الهوية والحساب، ملف المزوّد ومعرضه، التحقق والاشتراك، الأمان، الشكاوى والمراجعة الإدارية، السمعة والتقييم.

`Log In` هو العملية الأساسية المشتركة في كلا المخططين، وترتبط به المجموعات اللاحقة عبر شريط **Precondition** رأسي؛ لأن Authentication شرط مسبق للوظائف المحمية ولا يُنمذج كـ`<<include>>` وفق DEC-077. التسميات داخل الأشكال إنجليزية (DEC-072) مع سطر عربي توضيحي، والعلاقات المعروضة هي العلاقات المعتمدة في الجدول أعلاه فقط.

هذه الملفات Generated Exports مشتقة من هذه الوثيقة و`10-UML.md`، ولا تُعدَّل يدويًا.
