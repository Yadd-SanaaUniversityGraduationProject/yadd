...
>
> **القرار المرجعي:** `LOC-Q01` + `LOC-OPS-Q01` — قرار الفريق 2026-08-12، مع تحقق خارجي من توفر تقنيات الخرائط وحدود الاعتماد عليها في اليمن.
...
5. إذا رفض أو تجاهل الطلب، يبقى النطاق على الحي الحالي إلى أن يقرر التوسيع لاحقًا أو ينتهي الطلب وفق مدة صلاحيته.
