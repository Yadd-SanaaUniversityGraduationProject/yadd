...
**الحالة:** `ASSUMPTION/PROJECT_CLAIM` حتى تدعمها مقابلات/ملاحظة/بحث في `02-data-gathering.md`.
...
- التخطيط الإداري: موجود ويحتاج محاذاة.
- البحث: مطلوب فورًا.
- Data Gathering: مطلوب فورًا.
- SRS: Draft مقترح يحتاج تحليل واعتماد.
- Modeling/Design: يبدأ بعد ثبات المتطلبات الحرجة.
