...
>
> **القرارات المرجعية:** `DEC-015/016/025/050/051/055/058` — مزامنة 2026-09-02.
...
- ما إذا كان المقدم سيقيّم المستفيد بعد ذلك **مفتوح في `RAT-CUST-Q01`**؛ لا يفترض وجود هذا التقييم أو عدمه قبل القرار.
...
- `RAT-CUST-Q01`: هل يوجد تقييم من المقدم للمستفيد بعد المعاملة، وما نموذجه إن اعتمد.
