...
| BR-OPEN-20 | عدد Provider Activities/التصنيفات داخل النوع الواحد وطريقة تمثيلها النهائية | `NEEDS_ANALYSIS` | PROV-ACT-Q01 |
...
- حصرية نوع المقدم في DEC-074 لا تحسم عدد الأنشطة/التصنيفات داخل النوع الواحد.