...
| BR-015 | لا يوجد في النموذج الحالي تقييم للمستفيد من مقدم الخدمة/المنتج ولا Double-Blind أو مهلة 14 يومًا. | `ANALYZED_APPROVED` | DEC-051 |
| BR-016 | لا يسمح بالتقييم إلا للمستفيد المرتبط بمعاملة مكتملة بفاتورة معتمدة مع ذلك المقدم. | `ANALYZED_APPROVED` | DEC-051 |
