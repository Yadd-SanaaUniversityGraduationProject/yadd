...
>
> تم اعتماد نموذج الحساب، نموذج نشاط المقدم، نموذج الموقع والمطابقة الجغرافية، وجزء جوهري من تدفق المعاملات. البنود المفتوحة موضحة صراحة ولا تعتبر متطلبات نهائية.
...
- `FR-015A` `ANALYZED_APPROVED` في أصل الحاجة: يحتاج النظام إلى بيانات مرجعية قابلة للإدارة للمديريات والأحياء وعلاقات الجوار المستخدمة في المطابقة الجغرافية.
...
## 10. Open Decisions Before v1.0

`VER-Q01`, `AI-Q01`, `DEP-Q01`, `SUB-Q02`, `RAT-VIS-Q01`, `LOC-DATA-Q01`, `LOC-OPS-Q01`.
