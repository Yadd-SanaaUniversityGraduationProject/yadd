...
| UML | Use Case/Activity/Sequence/Class | `DRAFT FOR PRELIMINARY DEFENSE — SEMANTICS SYNCHRONIZED THROUGH DEC-091` | 5 Use Case views + 20 Activity diagrams + 20 rendered Sequence diagrams synchronized; final academic export/Visual/A4 review remains open |
| ERD | النموذج المفاهيمي/الفيزيائي المتتبع | `DRAFT FOR PRELIMINARY DEFENSE — 32-TABLE ALIGNMENT SYNCHRONIZED 2026-09-20 THROUGH DEC-091` | Conceptual semantics preserved; adopted 32-table physical mapping synchronized; final academic visual/A4 review pending |
...
| Database Design / Relation Schema | Relation Schema | `DRAFT FOR PRELIMINARY DEFENSE — 32-TABLE PHYSICAL MODEL SYNCHRONIZED 2026-09-20 THROUGH DEC-091 — NOT BASELINED` | ApplicationUser/Identity mapping + exact field names/SQL types + 32-table set synchronized; final nullability/constraints/indexes/cascade/migrations remain open |
