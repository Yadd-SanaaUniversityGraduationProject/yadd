...
| Previous Studies Evidence Map | ربط الدراسات بالادعاءات | `ACTIVE / NEEDS_REVIEW` | استكمال الدراسات والملاحظات قبل الفصل الثاني |
| Stakeholders | تحديد الأطراف | `DRAFT / NEEDS_SYNC` | مزامنة الأدوار الحالية ثم مراجعة الفريق |
| Data Gathering | أدوات وأدلة جمع البيانات | `DRAFT / EVIDENCE_IN_PROGRESS` | تثبيت نتائج الاستبيانات/المقابلات والأدلة |
