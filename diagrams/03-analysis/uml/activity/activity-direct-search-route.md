...
- `DEC-012`, `DEC-031..033`, `DEC-046`, `DEC-047`, `DEC-064`, `DEC-066`, `DEC-069`, `DEC-075`, `DEC-082`, `DEC-086`
...
flowchart TD
    ...
    H -- Confirm --> H1{Provider eligible for new interaction?}
    H1 -- Yes --> I[Create Active Transaction]
    H1 -- No --> H2[Reject New Transaction Start / Keep Conversation Available]
    H2 --> K
...
- `Active Transaction` is created only after the other party confirms within 12 hours **and** the Provider remains eligible for a new interaction, including Active Subscription under DEC-086.
- Expired Subscription does not close the Provider Portal or an existing Transaction, but it blocks creation of a new Direct Search Transaction until renewal. Public-search visibility while expired remains an open policy and is not inferred here.
